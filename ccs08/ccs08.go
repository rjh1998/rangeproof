...
import (
	...
	"rangeProof/crypto/bbsignatures"
	"rangeProof/crypto/bn256"
	"rangeProof/util/bn"
	"rangeProof/util/intconversion"
)
...
func ProveUL(x, r *big.Int, p paramsUL) (proofUL, error) {
	...
	decx, _ := util.Decompose(x, p.u, p.l)
	...
	proof_out.C, _ = util.Commit(x, r, p.H)
	// Fiat-Shamir heuristic
	proof_out.c, _ = util.Hash(proof_out.a, proof_out.D)
...
*/
func (zkrp *ccs08) SetupParams(a, b int64) error {
...
*/
func (zkrp *ccs08) RangeProve() error {
...
*/
func (zkrp *ccs08) RangeVerify() (bool, error) {
